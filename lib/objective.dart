...
//            borderRadius: BorderRadius.circular(40),
  ...
  final profileData = Column(
    ...
    children: <Widget>[
      ...
      Text(
        "are 3; they are connected through the implementation of mobile platforms:\n"
        "\n"
            "- To tell interactive stories that awaken reason and critical thinking.\n"
            "\n"
            "- To promote the development of democratically self-directed and self-owned companies.\n"
            "\n"
            "- To make affordable access to psychoanalytic treatments possible for people who need it.",
        softWrap: true,
        textScaleFactor: 1.5,
